...
// @grant         GM_setValue
// @noframes
// @homepageURL   https://github.com/KudoAI/chatgpt.js-greasemonkey-starter/#readme
...
(async () => {
    ...
    if (!config.skipAlert)
        chatgpt.alert('≫ ChatGPT script loaded! 🚀', // title
            ...
            function getHelp() { window.open('https://github.kudoai.com/chatgpt.js-greasemonkey-starter/issues', '_blank', 'noopener') },
            function dontShowAgain() { saveSetting('skipAlert', !config.skipAlert) }
        )
    ...
    function saveSetting(key, val) { GM_setValue(config.prefix + '_' + key, val) ; config[key] = val }
